...
/*
  이상의 부분에서 주의할 점은 한계값 바로 앞까지만 불러온다는 점입니다. 그래서 31번라인의 경우 12번 index까지라고 했을 때 Banana라는 결과값이라고 착각할 수 있습니다.
...
/*
  ...
  마이너스인덱스
  맨 마지막 문자열의 index를 -1으로 잡고 앞으로 올때마다 -1을 더해줌
*/
...
/*
  83번 라인의 경우 처음보는 형태입니다.
  JS 정규식 표현식을 썻는데 추후 설명 예정이고 i는 insensitive의 축약어로 덜 깐깐하게 굴겠다는 겁니다.
